...
Applies the user-supplied criteria functions to each endpoint to
determine eligibility based on the criteria. The result is a logical
column added to the data indicating whether each endpoint meets the
criteria.
...
- ep:
  ...
  data, typically the output from `add_event_index`.
...
#>    endpoint_id crit_accept_endpoint
#>         <char>               <lgcl>
#> 1:      1-0001                 TRUE
```
